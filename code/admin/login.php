    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Or <a href="../login.php" class="font-medium text-blue-600 hover:text-blue-500">sign in as a regular user</a>
            </p>
        </div>
        ...
        <form class="mt-8 space-y-6" action="login.php" method="POST">
            ...
            <div class="flex items-center justify-between">
                <div class="text-sm">
                    <a href="../forgot-password.php" class="font-medium text-blue-600 hover:text-blue-500">Forgot your password?</a>
                </div>
            </div>
